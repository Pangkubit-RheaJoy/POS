...
<body class="cbp-spmenu-push">
  ...
  ?>
    ...
    <div class="panel panel-primary">
        ...
        <form id="requestForm" method="post" action="config/addstaff.php">
    ...
    <div class='table-responsive' style='max-height: 600px; overflow-y: auto; overflow-x: auto;'>
        <table class='table table-striped table-bordered table-hover table-fixed' id='drinkTable' width='100%' cellspacing='0'>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `tbl_user_account` INNER JOIN tbl_staff WHERE tbl_user_account.staff_id = tbl_staff.staff_ID";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#editModal" . $row['User_Acc_ID'] . "'><i class='fas fa-edit'></i></button>";
