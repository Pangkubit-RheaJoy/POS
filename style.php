...
<body class="cbp-spmenu-push">
  ...
  ?>
    ...
    <div class="panel panel-primary">
        ...
        <form id="requestForm" method="post" action="config/addplain.php">
       ...
       <option value=""></option>
            ...
            ?>
                ...
                <div class="form-group">
                    <label>CATEGORY</label>
                    <input type="text" class="form-control" name="plain" required>
                </div>
    ...
    <div class='table-responsive' style='max-height: 600px; overflow-y: auto; overflow-x: auto;'>
        <table class='table table-striped table-bordered table-hover table-fixed' id='drinkTable' width='100%' cellspacing='0'>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `plain`INNER JOIN category WHERE plain.category_id = category.category_id";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#editModal" . $row['plain_id'] . "'><i class='fas fa-edit'></i></button>";
                    ...
                    // No records found
                    echo "<tr><td colspan='5' class='text-center'>No Plain Color found.</td></tr>";
                }
